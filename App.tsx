    ...
    return (
      <div className="min-h-screen bg-primary-400 flex flex-col items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md relative z-10">
          ...
          <p className="text-center text-stone-500 mb-8">Discover platonic friends nearby.</p>
        ...
        {view === ViewState.PROFILE && (
          <div className="p-6">
            ...
            <div className="space-y-6">
                ...
                <Button variant="secondary" fullWidth onClick={() => setView(ViewState.AUTH)}>Log Out</Button>
            </div>
          </div>
        )}
      </main>
